        ...
        <div className="container-fluid">
          <div className="row">
            <div className="col-lg-4 col-md-6 col-sm-12 col-xs-12">
              <div className="card">
                <div className="card-body">
                  <h5 className="card-title">Mail us at... <i className="fas fa-envelope-open-text"></i></h5>
            ...
            <div className="col-lg-4 col-md-6 col-sm-12 col-xs-12">
              <div className="card">
                <div className="card-body">
                  <h5 className="card-title">Calling... <i className="fas fa-phone-volume"></i></h5>
            ...
            <div className="col-lg-4 col-md-6 col-sm-12 col-xs-12">
              <div className="card">
                <div className="card-body">
                  <h5 className="card-title">Drop in by... <i className="fas fa-shipping-fast"></i></h5>
